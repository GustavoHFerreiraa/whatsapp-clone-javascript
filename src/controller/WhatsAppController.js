...
export class WhatsAppController{
    ...
    constructor(){
        ...
        this.loadElements();
        //transformando os id em camelCase
        this.initEvents();
        //onde cria todos os eventos
        this._firebase = new Firebase();
        ...
        this._firebase.initAuth().then(response=>{
            ...
            this._user.on('datachange', data =>{
                ...
                if(data.photo){
                    ...
                    let photo = this.el.imgDefaultPanelEditProfile;
    ...
    initEvents(){
        ...
        this.el.inputNamePanelEditProfile.on('keypress', e=>{
            ...
            if(e.key === 'Enter'){
                ...
                e.preventDefault();
                //esse prevent impede da pagina atualizar assim que fizer um novo envio 
        ...
        this.el.btnSendPicture.on('click', e=>{
            ...
            picture.onload = e=>{
                ...
                contex.translate(picture.width, 0);
                contex.scale(-1, 1);
                
                contex.drawImage(picture, 0, 0, canvas.width, canvas.height);
        ...
        this.el.panelEmojis.querySelectorAll('.emojik').forEach(emoji=>{
            ...
            emoji.on('click', e=>{
                ...
                //ele pega o range desdo o começo ou seja 0
                range.deleteContents();
                //ele apagar o range selecionado
                ...
                //com dispatchEvent consegue forçar com que um evento aconteça
            });
    ...
    closeAllLeftPanels(){
    //fecha qualquer painel aberto antes de abrir o selecionado
